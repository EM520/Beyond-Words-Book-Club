  ...
  return (
    <>
      <div className={styles.replyView}>
        <img src={parent.photo} alt={parent.id} className={styles.discImg} />
      ...
      <div style={{ marginLeft: '55px' }}>
        <button onClick={handleShowReply} className={styles.reply}>
          Reply
        </button>
        {parent.replies ? <DiscussionReply replies={parent.replies} /> : null}
